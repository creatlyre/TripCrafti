/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4f960fcbabd6dbe196145e5cd5a68b2b)
// Runtime types generated with workerd@1.20250906.0 2025-02-04 
declare namespace Cloudflare {
	interface Env {
		...
		PUBLIC_FX_API_BASE: string;
		EXCHANGERATE_API_KEY: string;
		ITINERARY_PROCESSOR: DurableObjectNamespace /* ItineraryDurableObject from tripcrafti */;
		ITINERARY_GENERATOR: DurableObjectNamespace /* ItineraryDurableObject */;
