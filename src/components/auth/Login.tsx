...
const appearance = {
  ...
  className: {
    container: 'space-y-5',
    divider: 'relative my-6 text-[11px] uppercase tracking-wide text-slate-500 before:content-[""] before:absolute before:left-0 before:top-1/2 before:h-px before:w-full before:bg-slate-700/60 before:-z-10',
    button: [
