...
export const ITEM_LIBRARY: Record<string, ItemDefinition> = {
  ...
  doc_passport: {
    id: 'doc_passport',
    name: 'Paszport',
    category: 'Dokumenty i Finanse',
    defaultQty: '1',
    tags: ['essential', 'documents', 'international'],
    relevance: 10,
    notes: 'Sprawdź datę ważności!',
  },
  doc_id: {
    id: 'doc_id',
    name: 'Dowód osobisty',
  ...
  doc_visa: {
    ...
    category: 'Dokumenty i Finanse',
    defaultQty: '1',
    tags: ['documents', 'international'],
    relevance: 10,
    notes: 'Jeśli wymagana',
  },
  doc_insurance_card: {
    id: 'doc_insurance_card',
    name: 'Karta ubezpieczenia (EKUZ)',
    category: 'Dokumenty i Finanse',
    defaultQty: '1',
    tags: ['documents', 'health', 'essential'],
    relevance: 9,
  },
  doc_copies: {
    id: 'doc_copies',
    name: 'Kopia dokumentów',
    category: 'Dokumenty i Finanse',
    defaultQty: '1',
    tags: ['documents', 'safety'],
    relevance: 7,
    notes: 'Przechowuj osobno od oryginałów',
  },
  fin_credit_card: {
    id: 'fin_credit_card',
  ...
  doc_tickets: {
    id: 'doc_tickets',
    name: 'Bilety (lotnicze/kolejowe)',
    category: 'Dokumenty i Finanse',
    defaultQty: '1',
    tags: ['essential', 'documents', 'travel_basics'],
    relevance: 9,
    notes: 'Wersja cyfrowa i/lub papierowa',
  },
  doc_hotel_confirmation: {
    id: 'doc_hotel_confirmation',
    name: 'Potwierdzenie rezerwacji',
    category: 'Dokumenty i Finanse',
    defaultQty: '1',
    tags: ['documents', 'travel_basics'],
    relevance: 8,
  },
  ...
  elec_phone: {
    ...
    defaultQty: '1',
    tags: ['essential', 'electronics'],
    relevance: 10,
  },
  elec_phone_charger: {
    id: 'elec_phone_charger',
  ...
  elec_powerbank: {
    ...
    category: 'Elektronika',
    defaultQty: '1',
    tags: ['essential', 'electronics', 'travel_basics'],
    relevance: 9,
  },
  elec_headphones: {
    id: 'elec_headphones',
    ...
    category: 'Elektronika',
    defaultQty: '1',
    tags: ['electronics', 'entertainment', 'comfort'],
    relevance: 8,
  },
  elec_adapter: {
    id: 'elec_adapter',
    ...
    category: 'Elektronika',
    defaultQty: '1',
    tags: ['electronics', 'international'],
    relevance: 9,
    notes: 'Sprawdź typ dla kraju docelowego',
  },
  elec_laptop: {
    id: 'elec_laptop',
    name: 'Laptop',
  ...
  elec_camera: {
    ...
    category: 'Elektronika',
    defaultQty: '1',
    tags: ['electronics', 'hobby', 'photography'],
    relevance: 5,
  },
  elec_camera_charger: {
    id: 'elec_camera_charger',
    name: 'Ładowarka do aparatu',
    category: 'Elektronika',
    defaultQty: '1',
    tags: ['electronics', 'hobby', 'photography'],
    relevance: 5,
  ...
  elec_ebook_reader: {
    id: 'elec_ebook_reader',
    name: 'Czytnik e-booków',
    category: 'Elektronika',
    defaultQty: '1',
  ...
  hyg_shower_gel: {
    ...
    tags: ['hygiene'],
    relevance: 8,
    notes: 'Wersja podróżna lub kup na miejscu',
  },
  hyg_shampoo: {
    id: 'hyg_shampoo',
    name: 'Szampon',
  ...
  hyg_sunscreen: {
    ...
    category: 'Higiena i Kosmetyki',
    defaultQty: '1',
    tags: ['hygiene', 'sun', 'beach', 'summer'],
    relevance: 9,
  },
  hyg_hairbrush: {
    id: 'hyg_hairbrush',
    name: 'Szczotka/grzebień do włosów',
    category: 'Higiena i Kosmetyki',
    defaultQty: '1',
    tags: ['hygiene'],
    relevance: 7,
  ...
  hyg_makeup: {
    ...
    category: 'Higiena i Kosmetyki',
    defaultQty: 'Zestaw',
    tags: ['hygiene', 'cosmetics'],
    relevance: 5,
  },
  hyg_makeup_remover: {
    id: 'hyg_makeup_remover',
  ...
  hyg_nail_clippers: {
    id: 'hyg_nail_clippers',
    name: 'Obcinacz do paznokci',
    category: 'Higiena i Kosmetyki',
    defaultQty: '1',
    tags: ['hygiene'],
    relevance: 5,
  ...
  aid_stomach: {
    id: 'aid_stomach',
    name: 'Leki na problemy żołądkowe',
    category: 'Apteczka',
    defaultQty: '1 op.',
    tags: ['health'],
    relevance: 8,
  ...
  aid_personal_meds: {
    id: 'aid_personal_meds',
    name: 'Leki osobiste',
    category: 'Apteczka',
    defaultQty: 'Zapas',
    tags: ['essential', 'health'],
    relevance: 10,
    notes: 'Weź więcej niż potrzeba',
  },
  aid_allergy: {
    id: 'aid_allergy',
    name: 'Leki na alergię',
    category: 'Apteczka',
    defaultQty: '1 op.',
    tags: ['health'],
    relevance: 7,
  },
  aid_insect_repellent: {
    id: 'aid_insect_repellent',
    name: 'Repelent na owady',
    category: 'Apteczka',
    defaultQty: '1',
    tags: ['health', 'summer', 'tropics'],
    relevance: 8,
  },
  aid_motion_sickness: {
    id: 'aid_motion_sickness',
    name: 'Leki na chorobę lokomocyjną',
    category: 'Apteczka',
    defaultQty: '1 op.',
    tags: ['health', 'travel_basics'],
    relevance: 7,
  },
  aid_blister_plasters: {
    id: 'aid_blister_plasters',
  ...
  cloth_tshirt: {
    id: 'cloth_tshirt',
    name: 'T-shirt / Koszulka',
    category: 'Ubrania',
    defaultQty: 'Na każdy dzień',
    tags: ['clothing'],
    relevance: 9,
  },
  cloth_trousers: {
  ...
  cloth_sweater: {
    ...
    category: 'Ubrania',
    defaultQty: '1-2',
    tags: ['clothing', 'winter', 'spring', 'autumn'],
    relevance: 8,
  },
  cloth_jacket: {
    id: 'cloth_jacket',
    ...
    tags: ['clothing', 'winter', 'spring', 'autumn'],
    relevance: 9,
    notes: 'Dostosuj do pogody',
  },
  cloth_rain_jacket: {
    id: 'cloth_rain_jacket',
    name: 'Kurtka przeciwdeszczowa',
    category: 'Ubrania',
    defaultQty: '1',
    tags: ['clothing', 'rain', 'hiking'],
    relevance: 8,
  },
  cloth_pyjamas: {
    id: 'cloth_pyjamas',
  ...
  cloth_swimsuit: {
    ...
    category: 'Ubrania',
    defaultQty: '1-2',
    tags: ['clothing', 'summer', 'beach', 'swimming'],
    relevance: 8,
  },
  cloth_elegant_outfit: {
    id: 'cloth_elegant_outfit',
    name: 'Elegancki strój',
    category: 'Ubrania',
    defaultQty: '1',
    tags: ['clothing', 'event', 'elegant'],
    relevance: 6,
    notes: 'Np. koszula, sukienka',
  },
  cloth_hat: {
    id: 'cloth_hat',
    name: 'Czapka / Kapelusz',
    category: 'Ubrania',
    defaultQty: '1',
    tags: ['clothing', 'sun', 'winter'],
    relevance: 7,
  },
  cloth_gloves: {
    id: 'cloth_gloves',
  ...
  shoe_sneakers: {
    id: 'shoe_sneakers',
    name: 'Wygodne buty (sneakersy)',
    category: 'Obuwie',
    defaultQty: '1',
    tags: ['essential', 'shoes'],
    relevance: 10,
  },
  shoe_sandals: {
    id: 'shoe_sandals',
  ...
  acc_sunglasses: {
    ...
    category: 'Inne',
    defaultQty: '1',
    tags: ['sun', 'summer', 'winter', 'car'],
    relevance: 8,
  },
  acc_reusable_bag: {
    id: 'acc_reusable_bag',
    name: 'Torba wielorazowa',
    category: 'Inne',
    defaultQty: '1',
    tags: ['eco', 'shopping'],
    relevance: 6,
  ...
  acc_water_bottle: {
    ...
    category: 'Inne',
    defaultQty: '1',
    tags: ['eco', 'hiking', 'sports'],
    relevance: 7,
  },
  acc_travel_pillow: {
    id: 'acc_travel_pillow',
    name: 'Poduszka podróżna',
    category: 'W Podróży (Podręczne)',
    defaultQty: '1',
    tags: ['comfort', 'travel_basics'],
    relevance: 6,
  },
  acc_snacks: {
    id: 'acc_snacks',
  ...
  kid_diapers: {
    ...
    name: 'Pieluchy',
    category: 'Dzieci',
    defaultQty: 'ok. 5/dzień',
    tags: ['kids', 'baby', 'essential'],
    relevance: 10,
    notes: 'Rozważ zakup na miejscu',
  },
  kid_wet_wipes: {
    id: 'kid_wet_wipes',
    name: 'Chusteczki nawilżane',
    category: 'Dzieci',
    defaultQty: 'Duża paczka',
    tags: ['kids', 'baby', 'essential'],
    relevance: 10,
  },
  kid_monitor: {
  ...
  kid_stroller: {
    ...
    category: 'Dzieci',
    defaultQty: '1',
    tags: ['kids', 'baby', 'travel_basics'],
    relevance: 9,
  },
  kid_car_seat: {
    id: 'kid_car_seat',
    name: 'Fotelik samochodowy',
    category: 'Dzieci',
    defaultQty: '1',
    tags: ['kids', 'baby', 'car', 'safety'],
    relevance: 10,
  },
  kid_carrier: {
    id: 'kid_carrier',
    name: 'Nosidełko dla dziecka',
    category: 'Dzieci',
    defaultQty: '1',
    tags: ['kids', 'baby', 'hiking'],
    relevance: 8,
  },
  kid_bib: {
    id: 'kid_bib',
  ...
  dog_food: {
    ...
    category: 'Psy',
    defaultQty: 'Zapas',
    tags: ['pets', 'dog', 'essential'],
    relevance: 10,
  },
  dog_bowl: {
    id: 'dog_bowl',
    name: 'Miska na wodę i karmę',
    category: 'Psy',
    defaultQty: '1',
    tags: ['pets', 'dog', 'essential'],
    relevance: 9,
  ...
  dog_passport: {
    id: 'dog_passport',
    name: 'Paszport/książeczka zdrowia psa',
    category: 'Psy',
    defaultQty: '1',
    tags: ['pets', 'dog', 'documents'],
    relevance: 10,
  },
  dog_poo_bags: {
    id: 'dog_poo_bags',
...
export function searchItems(query: string): ItemDefinition[] {
  ...
  return Object.values(ITEM_LIBRARY).filter(
    (item) =>
